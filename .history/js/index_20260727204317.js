        ...
        <a href="book.html?book=${book.id}" class="book-month-cover-link">
            ...
            <div class="book-month-text">
                ...
                <div class="book-month-action">
                    ...
                    <a href="book.html?book=${book.id}" class="buy-btn">Inspect Case File</a>
                </div>
            </div>
        `
    }
}
<img src="/assets/book/book_13.png" class="book-month-img" alt="Book of the Month">
<div class="book-month-text">
    <h3 class="book-month-title"></h3>
    <p class="book-month-details"></p>
</div>