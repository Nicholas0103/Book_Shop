...
│
├── js/
│   ├── about.js          # Structured array dataset holding book records
│   ├── book.js          # Structured array dataset holding book records
│   ├── contact.js        # Client-side form validation script
│   ├── index.js        # Client-side form validation script
│   ├── main.js              # Dynamic DOM rendering and catalog filter logic
│   └── shop.js           # Global navigation and interactive UI components
│
